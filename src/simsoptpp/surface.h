...
class Surface {
    ...
    public:
        ...
        virtual void gammadash1_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash1_lin was not implemented"); };
        virtual void gammadash2_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash2_lin was not implemented"); };
        virtual void gammadash1dash1_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash1dash1_lin was not implemented"); };
        virtual void gammadash1dash2_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash1dash2_lin was not implemented"); };
        virtual void gammadash2dash2_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash2dash2_lin was not implemented"); };

        virtual void gammadash1dash1dash1_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash1dash1dash1_lin was not implemented"); };
        virtual void gammadash1dash1dash2_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash1dash1dash2_lin was not implemented"); };
        virtual void gammadash1dash2dash2_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash1dash2dash2_lin was not implemented"); };
        virtual void gammadash2dash2dash2_lin(Array& data, Array& quadpoints_phi, Array& quadpoints_theta) { throw logic_error("gammadash2dash2dash2_lin was not implemented"); };
